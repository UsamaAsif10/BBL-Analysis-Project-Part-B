...
{\LARGE\bfseries ADELAIDE UNIVERSITY\par}
...
All code runs in Python. The modelling pipeline is in \texttt{Home\_win\_model~(1).ipynb};
extended analyses are in \texttt{BBL\_Extended\_Analysis.ipynb}. Code is available at:
\url{https://github.com/UsamaAsif10/BBL-Analysis-for-Data-Science-project-A}.
...
Note: the repository was created for Project~A and contains code for both Project~A and
Project~B analyses.
